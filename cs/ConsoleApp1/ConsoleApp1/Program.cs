...
Util.popularLista(listaPente, qtd);
Util.copiarLista(listaPente, listaInsercao);
Util.copiarLista(listaPente, listaQuick);
Util.copiarLista(listaPente, listaHeap);
Util.copiarLista(listaPente, lista);
